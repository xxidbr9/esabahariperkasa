      ...
      <main className='bg-white'>
        ...
        <div className='flex flex-col laptop:gap-y-10'>
          <TagLine title={"Vision"}>
            To provide the best quality in every service in the
            shipping world to get a sense of security and
            comfort.
          </TagLine>
          <TagLine title={"Mision"}>
            Uphold the value of high commitment in
            realizing trust for the benefit of customers and
